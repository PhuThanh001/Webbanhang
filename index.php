...
<head>
  ...
  <style>
    ...
    .product {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); /* Tự động điều chỉnh */
...
/* Định dạng hình ảnh */
.product-item img {
    width: 50%; /* Ảnh tự động fit với khung */
    height: auto;
    ...
    position: relative;
    z-index: 2; /* Giữ header trên cùng */
}

.swiper-container {
    position: relative;
    z-index: 1; /* Đảm bảo Swiper không bị đè */
    margin-top: 200%; /* Tạo khoảng cách giữa header và Swiper */
    width: 100%;
    max-width: 800px; /* Giới hạn kích thước Swiper */
    height: auto;
    overflow: hidden;
}
...
.swiper-button-next,
.swiper-button-prev {
    color: black; /* Màu sắc nút điều hướng */
}
/* Responsive cho màn hình nhỏ hơn */
@media (max-width: 768px) {
    .swiper-container {
        max-width: 100%;
        margin-top: 10px; /* Điều chỉnh khoảng cách trên mobile */
    }
}
.card {
    transition: transform 0.2s ease-in-out;
